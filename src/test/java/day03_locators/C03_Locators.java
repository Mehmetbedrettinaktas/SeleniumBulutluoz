...
public class C03_Locators {
    ...
    public static void main(String[] args) {
        ...
        WebElement passworTextBox= driver.findElement(By.name("session[password]"));
        WebElement signinButonu= driver.findElement(By.name("commit"));
        //  d. Kullanıcı adını ve şifreyi aşağıya girin ve oturum aç (sign in)buttonunu tıklayın:
        //  i. Username : testtechproed@gmail.com
        //  ii. Password : Test1234!
        emailTextBox.sendKeys("testtechproed@gmail.com");
        passworTextBox.sendKeys("Test1234!");
        signinButonu.click();
        // Bir webelementin uzerinde ne yazdigin gormek istiyorsak webelementinIsmi.getText() methodu'nu kullaniriz
        //  e. Expected user id nin testtechproed@gmail.com oldugunu dogrulayin(verify).
        ...
        }else System.out.println("signOutElementi testi FAILED");
        //  3. Sayfada kac tane link oldugunu bulun.
        List<WebElement> linklerListesi = driver.findElements(By.tagName("a"));
        System.out.println("Sayfadaki link sayisi "+linklerListesi.size());
        // linkleri yazdiralim
        // listemiz webelementlerinden olustugu icin, direk yazdirsak referanslari yazdirir
        // onun yerine for-each loop yapip her bir link webelementlerinin uzerindeki yaziyi yazdirmaliyiz
